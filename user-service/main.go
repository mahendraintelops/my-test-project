...
import (
	...
	"github.com/mahendraintelops/my-test-project/user-service/config"
	restcontrollers "github.com/mahendraintelops/my-test-project/user-service/pkg/rest/server/controllers"
